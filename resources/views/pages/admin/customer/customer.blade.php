                    ...
                    <table id="pagination" class="table table-hover display">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->password; ?></td>
                                <td>
                                    <button type="button" class="btn  btn-icon btn-sm btn-primary" data-toggle="modal" data-target="#formCustomer" data-mode="edit" data-id="{{ $row->id }}" data-namacustomer="{{ $row->name }}" data-email="{{ $row->email }}" data-password="{{ $row->password }}"><i class="feather icon-edit"></i></button>
                                    <button type="button" class="btn  btn-icon btn-sm btn-danger" data-toggle="modal" data-target="#deleteCustomer" data-id="{{ $row->id }}" data-gambar="{{ $row->gambar }}" data-namacustomer="{{ $row->name }}"><i class="feather icon-trash"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
